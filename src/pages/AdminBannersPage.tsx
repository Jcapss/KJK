    ...
    <AdminLayout>
      <div className="mx-auto w-full max-w-6xl p-4 sm:p-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button
            onClick={openCreate}
            className="w-full sm:w-auto rounded-md bg-black px-4 py-2 text-sm font-semibold text-white hover:bg-black/80"
          >
            + Add Banner
          </button>
        </div>
                ...
                <div className="flex items-start justify-between gap-3 border-b p-4 sm:p-5">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      Tip: on mobile, scroll down for the preview and buttons.
                    </p>
                  </div>

                  <button
                    onClick={() => setOpen(false)}
                    className="rounded-md border px-3 py-2 text-xs font-semibold hover:bg-gray-50"
                  >
                    ✕
                  </button>
                </div>
                          ...
                          <div className="max-w-[92%]">
                            ...
                            {form.subtitle ? (
                              <div
                                ...
                                style={{ color: form.subtitle_color }}
                              >
                                {form.subtitle}
                              </div>
                            ) : null}
